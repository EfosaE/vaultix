    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex items-center gap-4">
              ...
              <Button variant="ghost" className="text-purple-600 hover:text-purple-900 hover:bg-purple-50">
                Recent
              </Button>
              <Button variant="ghost" className="text-purple-600 hover:text-purple-900 hover:bg-purple-50">
                Trash
          ...
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="text-purple-600 hover:text-purple-900 hover:bg-purple-50">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-2 hover:bg-purple-50">
                  ...
                  <span className="hidden md:block text-gray-900">John Doe</span>
                </Button>
              </DropdownMenuTrigger>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-purple-100 bg-white/50 backdrop-blur-sm">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-600">Shared Files</CardTitle>
          ...
          <Card className="border-purple-100 bg-white/50 backdrop-blur-sm">
            ...
            <CardContent>
              <div className="text-xs text-purple-600">Across 3 departments</div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <Input placeholder="Search files..." className="pl-10 border-gray-200 focus:border-purple-400 w-64" />
            </div>
            ...
            <div className="flex border border-purple-200 rounded-lg">
              <Button
                ...
                size="icon"
                className={
                  viewMode === "grid" ? "bg-purple-600 hover:bg-purple-700" : "text-purple-600 hover:bg-purple-50"
                }
              ...
              <Button
                ...
                size="icon"
                className={
                  viewMode === "list" ? "bg-purple-600 hover:bg-purple-700" : "text-purple-600 hover:bg-purple-50"
                }
        ...
        {viewMode === "grid" ? (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {files.map((file) => (
              <Card
                key={file.id}
                className="border-purple-100 hover:shadow-lg transition-all duration-200 bg-white/50 backdrop-blur-sm group cursor-pointer"
              >
                <CardHeader className="pb-3">
